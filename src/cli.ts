...
program
  .name("vinfer")
  .description("Extract input/output types from Valibot schemas")
...
/**
 * Reads vinfer's own version from its package.json.
 *
 * The path is the same whether this file runs from `src` or from `dist`, since
